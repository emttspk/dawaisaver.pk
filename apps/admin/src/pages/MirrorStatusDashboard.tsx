            ...
            <div className="grid gap-4 xl:grid-cols-[1.2fr_0.8fr]">
              <section className="rounded-[2rem] border border-slate-200 bg-white p-5 shadow-sm">
                <div className="flex items-center justify-between gap-3">
                  <div>
                    <h2 className="text-xl font-bold">Worker batches</h2>
                    <p className="mt-1 text-sm text-slate-600">{data.batches.length} batch snapshots in the active run</p>
                  </div>
              ...
              <section className="space-y-4">
                ...
                <Panel
                  ...
                  body={<pre className="max-h-[28rem] overflow-auto rounded-2xl bg-slate-950 p-4 text-xs leading-6 text-slate-100">{JSON.stringify(data, null, 2)}</pre>}
                />
              </section>
            </div>
          </>
