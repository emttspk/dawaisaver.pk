        ...
        try {
          ...
          if (record.rawHtml) {
            ...
            if (isContract) {
              ...
              // Get the manufacturer section HTML
              const mfgIdx = record.rawHtml.indexOf('Manufacturer (Contract');
              if (mfgIdx > 0) {
                console.log('Full manufacturer section HTML:');
                console.log(record.rawHtml.substring(mfgIdx, mfgIdx + 2000));
              }
              break;
            }
          }
