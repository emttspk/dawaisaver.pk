...
set WEB_UUID=%1
echo Deploying Web application: %WEB_UUID%

curl -s -X POST -H "Authorization: Bearer %COOLIFY_TOKEN%" -H "Content-Type: application/json" "%COOLIFY_URL%/api/v1/applications/%WEB_UUID%/start"
echo.