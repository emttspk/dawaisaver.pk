...
function mapDrapMirrorParsedRecord(
  ...
  return {
    record: {
      ...
      routeOfAdmin: cleanText(record.routeOfAdmin) || undefined,
      atcCode: cleanText(record.atcCode) || undefined,
      applicant: cleanText(record.manufacturer) || undefined,
      country: cleanText(record.country) || undefined,
      registrationStatus: cleanText(record.sourceStatus) || undefined,
      storageConditions: cleanText(record.storageCondition) || undefined,
      shelfLife: cleanText(record.shelfLife) || undefined,
      therapeuticCategory: cleanText(record.therapeuticCategory) || undefined,
      drapFields: {
        companyAddress: cleanText(record.companyAddress),
        activeIngredient: cleanText(record.activeIngredient),
        dosage: cleanText(record.dosage),
        packageType: cleanText(record.packageType),
        therapeuticCategory: cleanText(record.therapeuticCategory),
        atcCode: cleanText(record.atcCode),
        indications: cleanText(record.indications),
        contraindications: cleanText(record.contraindications),
        sideEffects: cleanText(record.sideEffects),
        drugInteractions: cleanText(record.drugInteractions),
        precautions: cleanText(record.precautions),
        warnings: cleanText(record.warnings),
        shelfLife: cleanText(record.shelfLife),
        storageCondition: cleanText(record.storageCondition),
        country: cleanText(record.country),
        manufacturingType: cleanText(record.manufacturingType),
      },
    },
    issues: [],
  };
